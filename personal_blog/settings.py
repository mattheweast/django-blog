...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-8irb1rqwg)qtsyznkuhg#!w8$9@o=0pyc-177(9#ue(4k4vz0q')
...
# Additional places Django will look for static files (in development)
STATICFILES_DIRS = [
